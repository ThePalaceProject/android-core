...
dependencies {
    ...
    api(project(":simplified-bookmarks"))
    api(project(":simplified-bookmarks-api"))
    ...
    api(project(":simplified-deeplinks-controller-api"))
    ...
    api(project(":simplified-ui-neutrality"))
    ...
    api(project(":simplified-viewer-pdf-pdfjs"))
    api(project(":simplified-viewer-preview"))
    ...
    api(libs.palace.drm.core)
    api(libs.palace.http.api)
    api(libs.palace.http.bearer.token)
    api(libs.palace.http.vanilla)
    api(libs.r2.lcp)
    api(libs.rxandroid2)
    api(libs.rxjava2)
