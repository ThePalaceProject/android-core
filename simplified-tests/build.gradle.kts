...
val dependencyObjects = listOf(
    ...
    libs.androidx.app.compat,
    libs.androidx.cardview,
    libs.androidx.constraint.layout,
    ...
    libs.androidx.swiperefresh.layout,
    ...
    libs.google.play.services.base,
    libs.google.play.services.location,
    libs.google.play.services.measurement.api,
    libs.google.play.services.tasks,
    libs.hamcrest,
