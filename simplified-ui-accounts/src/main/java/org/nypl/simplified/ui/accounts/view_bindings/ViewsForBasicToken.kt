...
class ViewsForBasicToken(
  ...
  fun isSatisfied(description: AccountProviderAuthenticationDescription.BasicToken): Boolean {
    val noUserRequired =
  ...
  fun configureFor(description: AccountProviderAuthenticationDescription.BasicToken) {
  ...
  companion object {
    fun bind(
      ...
      return ViewsForBasicToken(
        ...
        user = viewGroup.findViewById(R.id.authBasicTokenUserField),
        userLabel = viewGroup.findViewById(R.id.authBasicTokenUserLabel),
        showPass = viewGroup.findViewById(R.id.authBasicTokenShowPass),
        onUsernamePasswordChangeListener = onUsernamePasswordChangeListener,
        loginButton = viewGroup.findViewById(R.id.authBasicTokenLogin),
