...
class OnboardingDefaultViewModelFactory(fallbackFactory: ViewModelProvider.Factory) :
  ...
  override fun onListenerRepositoryCreated(repository: ListenerRepository<OnboardingListenedEvent, Unit>) {
    repository.registerListener(AccountListRegistryEvent::class,
      OnboardingListenedEvent::AccountListRegistryEvent
    )
    repository.registerListener(
      OnboardingStartScreenEvent::class,
      OnboardingListenedEvent::OnboardingStartScreenEvent
    )
  }
}
